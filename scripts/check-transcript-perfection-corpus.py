...
def build_fixture(root: Path) -> Path:
    ...
    payloads: dict[str, tuple[Path, dict[str, object], list[str]]] = {
        ...
        "remote_speaker_enrollment_purity_abstention_hardening_v2": (
            files / "remote-speaker-enrollment-purity-abstention-hardening-v2.json",
            {
                "schema": "murmurmark.remote_speaker_enrollment_purity_abstention_report/v2",
                "decision": "KEEP_COVERAGE_V3",
                "gates": {
                    "all_coverage_v3_accepts_preserved": True,
                    "exact_word_and_timestamp_conservation": True,
                    "no_changed_accepted_identity": True,
                    "no_lost_correct_control_identity": True,
                    "no_new_false_identity": True,
                    "deterministic_replay": True,
                },
                "safety": {
                    "production_mutated": False,
                ...
                "portable_aggregate": {
                    ...
                    "candidate_fail_closed_unsafe_accepts": 8,
                    "preserved_confirmed_v1_gains": 0,
                    "qualified_profiles": 7,
                    "rejected_profiles": 7,
                },
            },
            ["remote_speaker_turns"],
        ...
        "session_local_homogeneous_remote_speaker_enrollment_mining_v1": (
            files / "session-local-homogeneous-remote-speaker-enrollment-mining-v1.json",
            {
                "schema": "murmurmark.session_local_homogeneous_remote_speaker_enrollment_report/v1",
                "decision": "KEEP_EXISTING_ENROLLMENT",
                "replay_verified": True,
                "mining": {
                    "qualified_profiles": 9,
                    "selected_windows": 39,
                ...
                "development": {
                    ...
                    "unsafe_fail_closed_accepts": 5,
                    "new_false_identity_items": 4,
                    "lost_correct_control_identity_items": 3,
                },
                "gates": {
                    "candidate_pack_frozen_before_truth": True,
        ...
        "session_local_remote_speaker_reclustering_feasibility_v1": (
            files / "session-local-remote-speaker-reclustering-feasibility-v1.json",
            {
                "schema": "murmurmark.session_local_remote_speaker_reclustering_report/v1",
                "decision": "EMBEDDING_GEOMETRY_BOUND",
                "replay_verified": True,
                "scope": {"sessions": 6, "profiles": 14, "windows": 347, "development_items": 33},
                "geometry": {
                    "values": {
                        "minimum_model_agreement_ari": 0.09017,
                        "minimum_model_agreement_nmi": 0.231989,
                    },
                    "gates": {"minimum_model_agreement_ari": False},
                },
                "mapping": {
                    "values": {"ambiguous_clusters": 12},
                    "gates": {"minimum_cluster_mapping_purity": False},
                },
                "direct_truth": {
                    "preserved_confirmed_v1_additive_gains": 0,
                    "confirmed_v1_additive_gains": 3,
