#!/usr/bin/env python3
"""Materialize v2.15 audio with window-identical candidate ASR preparation."""
...
PARENT = load_module(
    ...
    "murmurmark_spne_v215_audio_parent",
)
V210 = PARENT.PARENT
V27 = V210.V27
...
def seed_prior_cache(session: Path, output: Path) -> dict[str, Any]:
    source = session / "derived/preprocess/speaker-preserving-neural-echo-v2-14"
    ...
    payload["params"].update(
        {
            ...
            "murmurmark_echo_profile": "speaker_preserving_neural_echo_v2_15",
...
def run_session(args: argparse.Namespace) -> dict[str, Any]:
    ...
    try:
        ...
        for pass_index in range(1, 6):
            ...
            local_rollbacks.append(
                {
                    "schema": "murmurmark.speaker_preserving_neural_echo_local_rollback/v2.15",
                    "pass": pass_index,
    ...
    payload["schema"] = "murmurmark.speaker_preserving_neural_echo_runtime/v2.15"
    ...
    payload["v2_14_cache_seed"] = seeded
    ...
    payload["diagnostic_selection_reuse"] = {
        ...
        "reason": (
            ...
            else "seeded_v2_14_audited_selection"
        )
        if reuse_selection
...
def main() -> int:
    ...
    args.output = ROOT / "sessions/_reports/speaker-preserving-neural-echo-v2-15"
