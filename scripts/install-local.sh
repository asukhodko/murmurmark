...
echo "  murmurmark meeting --out \"\$SESSION\" --target-bundle system"
echo "  murmurmark acceptance --live-session \"\$SESSION\" --require-meeting-lifecycle --report /tmp/murmurmark-live-session.json"
