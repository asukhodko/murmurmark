#!/usr/bin/env python3
"""Run outcome-gated profile-matched shadow evaluation for v2.13 audio."""
...
CANDIDATE = "speaker_preserving_neural_echo_v2_13"
...
def run(args: argparse.Namespace) -> dict[str, Any]:
    ...
    output_root = candidate_root / "full-shadow-v2-13"
    ...
    payload["schema"] = "murmurmark.echo_suppression_full_shadow/v2.13"
    payload["candidate_profile"] = CANDIDATE
    payload["candidate_runtime_schema"] = (
        "murmurmark.speaker_preserving_neural_echo_runtime/v2.13"
    )
