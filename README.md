...
murmurmark corpus remote-truth-seed-v2 status && murmurmark corpus remote-truth-seed-v2 replay && murmurmark corpus remote-model-disjoint-v1 status && murmurmark corpus remote-model-disjoint-v1 replay
```
Disjoint truth v2 is complete: 72 primary + 12 repeats, consistency `1.0` and byte-exact replay.
The one-shot ERes2NetV2 qualification closed `KEEP_COVERAGE_V3`: 12/21 correct identities, precision `0.631579`, seven unsafe special accepts and perfect controlled hard. The current goal is
**Remote Speaker Usability Gate Error Decomposition v1**, before another model or threshold pass.
...
- [Independent evidence](docs/contracts/independent-remote-speaker-evidence-v1.md), [Controlled Truth Lab](docs/contracts/controlled-remote-speaker-truth-lab-v1.md), [Disjoint ERes2NetV2 result](docs/contracts/disjoint-remote-speaker-model-qualification-v1.md)
